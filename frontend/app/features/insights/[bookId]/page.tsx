    ...
    <div className="space-y-6">
      ...
      <div className="border-b border-gray-200 pb-4">
        <div className="flex items-center justify-between mb-2">
          ...
          <button
            onClick={() => router.push('/features/insights')}
        ...
        <p className="text-sm text-gray-600">
          Discover key themes, characters, quotes, and concepts from your book
        </p>
      </div>

      {/* Dashboard */}
      <BookInsightsDashboard bookId={bookId} bookTitle={book.title} />
    </div>
  );
}
